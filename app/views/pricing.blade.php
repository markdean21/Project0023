    ...
    <header>
        <div class="header-content">
            <div class="vegas.overlay" style="height:100%; width:100%; opacity:1; background-color:rgba(0,0,0,.8);"></div>
                <div class="header-content-inner wow bounceIn" style="background-color:rgba(0,0,0,.5); padding-top: 35px; padding-bottom:15px; border-radius: 8px;">
                    <h1>Pricing</h1>
                    <hr>
                    <p>There are list of prices for every Job</p>
...
<!-- BODY SECTION PULSSE -->
    <section id="next" style="border-bottom:1px solid #222">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center div_cons" data-wow-delay=".1s">
                    <p><h1>Still coding for some awesomeness..</h1></p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="col-lg-4">
                        ...
                        <h2><i class="fa fa-wrench"></i>  Proveek</h2>
                            <ul>
                                ...
                                <li><a href="#page-top" class="page-scroll">Pricing</a></li>
