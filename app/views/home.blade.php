    ...
    <header>
        ...
        <div class="header-content">
            <div class="header-content-inner">
                <h1>We pooled the blue-collars for you!</h1>
                <hr>
                <p>Proveek is an online Philippine directory platform of skilled workers which allows an individual to hire or outsource tasks from certified blue-collar workers in their locality.</p>
        ...
        <div class="container-fluid">
            <div class="row no-gutter">
                <div class="col-lg-3 col-sm-6">
                    <a href="#" class="portfolio-box text-center" style="text-decoration:none;">
...
<!-- PARTNERSHIP SLIDER -->
    <section class="bg-primary" style="background-image: url(img/fog_Bg.jpg); background-position: top; background-attachment: fixed; -webkit-background-size: cover; -moz-background-size: cover; background-size: cover; -o-background-size: cover; border-top: 1px solid #222; border-bottom: 1px solid #222; padding-top:40px; padding-bottom: 40px">
		<div class="item">
			<div class="container-fluid">
				<div class="row">
			        <div class="col-lg-1"></div>
				        ...
				        <ul id="lightSlider0" class="content-slider" style="color: #222;">
				            	...
				            	<div class="row">
				            		<div class="col-md-1"></div>
				            			<div class="col-md-10 text-center">
						                    <img src="frontend/img/logo_tesda.png">
					                    </div>
				                    <div class="col-md-1"></div>
				                </div>
				            </li>
				            <li>
				                <div class="row">
				            		<div class="col-md-1"></div>
				            			<div class="col-md-10 text-center">
						                    <img src="frontend/img/logo_tspi.png">
					                    </div>
				                    <div class="col-md-1"></div>
				                </div>
				            </li>
				            <li>
				                <div class="row">
				            		<div class="col-md-1"></div>
				            			<div class="col-md-10 text-center">
						                    <img src="frontend/img/logo_gwk.png">
					                    </div>
				                    <div class="col-md-1"></div>
				                </div>
				            </li>
