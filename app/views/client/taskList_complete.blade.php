...
<div class="row">
    ...
    @if($tasks->count() == 0)
        <div class="col-md-9">
            <div class="alert alert-danger">You have no accomplished tasks</div>
        </div>
    @endif
        ...
        <div class="widget-container weather">
            <div class="widget-content padded">
                ...
                <div class="widget-content clearfix" style="padding: 0px 40px;">
                    ...
                    <span style="font-size: 1.1em"><strong style="text-transform: uppercase">Completed at :</strong> &nbsp;&nbsp;{{ $task->completed_at }}</span><br/>
                    <span style="font-size: 1.1em"><strong style="text-transform: uppercase">Completed by :</strong> &nbsp;&nbsp;{{ User::where('id', $task->completed_by)->pluck('fullName') }}</span><br/>
                </div>
            </div>
        </div><br/>
    </div>
